...
if __name__ == '__main__':
  ...
  model = PPO('MultiInputPolicy', vec_gym_env, n_steps = 400*3,verbose=2, tensorboard_log='./ppo_lift_4_objects_tensorboard/')
  print(f"envs and model setup in {toc_1 - tic:0.4f}")
  print("starting to learn")
  tic = time.perf_counter()
  model.learn(total_timesteps = 400*3*8*5, log_interval= 2, tb_log_name="test")
