...
class LiftSquareObject(SingleArmEnv):
    ...
    def __init__(
        ...
        objects = [LemonObject(name = "Lemon")],
    ):
        ...
        # position for over-the-shoulde-camera
    ...
    def _load_model(self):
        ...
        #import custom camaera

        mujoco_arena.set_camera("calibrated_camera",
        self.camera_pos,
        self.camera_quat,
        self.camera_attribs)
    ...
    def _setup_references(self):
        ...
        self.object_body_id = self.sim.model.body_name2id(self.target.root_body)
    ...
    def _setup_observables(self):
        ...
        if self.use_object_obs:
            ...
            sensors = [object_pos, object_quat, gripper_to_object_pos]
    ...
    def visualize(self, vis_settings):
        ...
        if vis_settings["grippers"]:
            self._visualize_gripper_to_target(gripper=self.robots[0].gripper, target=self.objects)
